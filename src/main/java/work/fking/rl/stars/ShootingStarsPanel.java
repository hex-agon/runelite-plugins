...
public class ShootingStarsPanel extends PluginPanel {
    ...
    public static class ScoutedStarComponent extends JPanel {
        ...
        public ScoutedStarComponent(ScoutedStar scoutedStar) {
            ...
            JLabel worldLabel = new JLabel("W" + scoutedStar.world() + " - " + scoutedStar.region().shortName());
            ...
            JLabel earliestLabel = new JLabel("Earliest: " + scoutedStar.earliestTime().toLocalTime().truncatedTo(ChronoUnit.MINUTES));
            timeWindow.add(earliestLabel);

            JLabel latestLabel = new JLabel("Latest: " + scoutedStar.latestTime().toLocalTime().truncatedTo(ChronoUnit.MINUTES));

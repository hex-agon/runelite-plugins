...
public enum StarRegion {
    ...
    KHARIDIAN_DESERT("Kharidian Desert",
            ...
            LandingSite.of("Mage Training Arena", new WorldPoint(3351, 3281, 0))
    ),
    MISTHALIN("Misthalin",
    ...
    public static final List<LandingSite> LANDING_SITES = Arrays.stream(values())
                                                                .map(StarRegion::landingSites)
                                                                .flatMap(Collection::stream)
                                                                .collect(Collectors.toList());

    private final String name;
    private final String shortName;
    private final List<LandingSite> landingSites;

    StarRegion(String name, LandingSite... landingSites) {
        this(name, name, landingSites);
    }

    StarRegion(String name, String shortName, LandingSite... landingSites) {
        this.name = name;
        this.shortName = shortName;
        this.landingSites = Arrays.asList(landingSites);
    }
    ...
    public List<LandingSite> landingSites() {
        return landingSites;
    }
    ...
    public static class LandingSite {
        ...
        public LandingSite(String name, WorldPoint location) {
            this.name = name;
            this.location = location;
        }

        public static LandingSite of(String name, WorldPoint location) {
            return new LandingSite(name, location);
        }
